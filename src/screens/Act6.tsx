...
import { LeakActivity, LeakControls } from '@/components/LeakControls'
import { StackActivity, StackControls } from '@/components/StackControls'
  ...
  return <>
    ...
    <main className="mx-auto flex lesson-content max-w-2xl flex-col justify-center gap-6 px-5 py-10 sm:py-12">
      <div className="lesson-activity">
        ...
        />
        <div className="lesson-activity-details">
          {nesting ? <StackActivity state={stack} dispatch={dispatchStack} />
          : investigate ? <LeakActivity state={leak} dispatch={dispatchLeak} /> : <>
